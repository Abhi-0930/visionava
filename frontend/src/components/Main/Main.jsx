...
// import featureIcon1 from "../../assets/emotion-icon.png"; 
// import featureIcon2 from "../../assets/communication-icon.png";
// import featureIcon3 from "../../assets/feedback-icon.png";
        ...
        <div className="section-container">
          ...
          >
            <div className="about-image-container">
              <img src={logoImage} alt="AI emotional analysis" />
            </div>
          </motion.div>
      ...
      <section className="features-section" ref={featuresRef}>
        <div className="section-container">
          ...
          <div className="features-grid">
            ...
            >
              <div className="feature-icon">
                <img src={logoImage} alt="Communication Analysis" />
              </div>
            ...
            >
              <div className="feature-icon">
                <img src={logoImage} alt="Personalized Feedback" />
              </div>
